...
### 7. Connect Power from IO Cells, Add Core (Power) Rings

### 8. Place IO Cells, Promote Top Level I/O Pins

### 9. Place Opt Design

### 10. Set CTS Buffer & Clock Gating Cells, Perform CTS (ccopt_design)
